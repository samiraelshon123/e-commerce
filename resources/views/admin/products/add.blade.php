...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-primary" style="width: 1240px;">
                @if ($errors->any())
                ...
                <form action="{{url('admin/table_add_product')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="descreption"
