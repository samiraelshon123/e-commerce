    ...
    <div class="card" style="width: 1230px;">
      ...
      <div class="card-body" >
        <div class="card-footer">
          <a href="{{url('admin/add_contact')}}" class="btn btn-primary">Add New</a>
        </div>
          ...
          <tbody>
            <tr>
                ...
                <tr>
                    ...
                    <td>{{$value->phone}}</td>
                    <td>
                        <a class="" href="{{ url('admin/edit_contact/'.$value->id) }}">
                            <i class="fas fa-edit"></i>
                        </a>
                    </td>
                    <td>
                        <a class="" href="{{ url('admin/delete_contact/'.$value->id) }}">
