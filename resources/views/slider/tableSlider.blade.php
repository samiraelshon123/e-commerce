    ...
    <div class="card" style="width: 1230px;">
      ...
      <div class="card-body" >
        <div class="card-footer">
          <a href="{{url('admin/add_slider')}}" class="btn btn-primary">Add New</a>
        </div>
          ...
          <tbody>
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{asset('images/'.$value->name)}}" width="100px" height="100px" alt="">
                    </td>
                    <td>
                        <a class="" href="{{ url('admin/edit_slider/'.$value->id) }}">
                            <i class="fas fa-edit"></i>
                        </a>
                    </td>
                    <td>
                        <a class="" href="{{ url('admin/delete_slider/'.$value->id) }}">
