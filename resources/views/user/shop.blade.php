                ...
                <div class="border-bottom mb-4 pb-4">
                    ...
                    <form>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            ...
                            <span class="badge border font-weight-normal">{{$all_products}}</span>
                        </div>
                       @foreach ($price as $key=>$price)
                            @if ($key==0)
                                <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <span class="badge border font-weight-normal">{{$price}}</span>
                                </div>
                            @elseif ($key==1)
                                <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                    <input type="checkbox" class="custom-control-input" id="price-1">
                            ...
                            @elseif ($key==2)
                                <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                    <input type="checkbox" class="custom-control-input" id="price-1">
                                    <label class="custom-control-label" for="price-1">$200 - $300</label>
                                    <span class="badge border font-weight-normal">{{$price}}</span>
                                </div>
                            ...
                            @elseif ($key==3)
                                <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                    <input type="checkbox" class="custom-control-input" id="price-1">
                                    <label class="custom-control-label" for="price-1">$300 - $400</label>
                                    <span class="badge border font-weight-normal">{{$price}}</span>
                                </div>
                            ...
                            @elseif ($key==4)
                                <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                    <input type="checkbox" class="custom-control-input" id="price-1">
                                    <label class="custom-control-label" for="price-1">$400 - $500</label>
                                    <span class="badge border font-weight-normal">{{$price}}</span>
                                </div>
                            @endif
                    ...
                    <form>
                        ...
                        @foreach ($color as $key=>$color)
                            ...
                            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                ...
                                <span class="badge border font-weight-normal">{{$color}}</span>
                            </div>
                            @elseif ($key==1)
                            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                    ...
                    <form>
                        ...
                        @foreach ($size as $key=>$size)
                            ...
                            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                ...
                                <span class="badge border font-weight-normal">{{$size}}</span>
                            </div>
                            @elseif ($key==1)
                            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
